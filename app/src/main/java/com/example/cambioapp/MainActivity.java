...
public class MainActivity extends AppCompatActivity {
    ...
    public void convert(View view) {
        ...
        if(input.length() == 0) {
            ...
            double dolar = Double.parseDouble(input.getText().toString()); // valor de entrada transformada em texto, passado pra double
            double real = dolar * 5.30;
            output.setText("R$ " + String.valueOf(real) + " reais");
        }
    }
}